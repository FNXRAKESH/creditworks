    ...
    <View style={styles.container}>
      <ScrollView>
        <Text style={styles.headingFormat}>
          Design the Loan That’s Right For You
        </Text>
        ...
        <Card style={styles.cardFormat1}>
          ...
          <View style={styles.cardView}>
            <Text style={styles.subHeading}>Loan Payment</Text>
            <Text style={styles.subHeading1}>$21.56</Text>
          </View>
          <View style={styles.cardView}>
            <Text style={styles.subHeading}>No of Payment</Text>
            <Text style={styles.subHeading1}>26</Text>
          </View>
          <TouchableOpacity
            style={styles.nextButtonContainer1}
            onPress={() => quickLoan()}
          >
            <Text style={styles.nextButton}>Select 6 Months</Text>
          </TouchableOpacity>
        </Card>
        <Card style={styles.cardFormat2}>
          ...
          <View style={styles.cardView}>
            <Text style={styles.subHeading}>No of Payment</Text>
            <Text style={styles.subHeading1}>48</Text>
          </View>
          <TouchableOpacity
            style={styles.nextButtonContainer2}
            onPress={() => quickLoan()}
          >
            <Text style={styles.nextButton}>Select 12 Months</Text>
          </TouchableOpacity>
        </Card>
        <Card style={styles.cardFormat3}>
          ...
          <View style={styles.cardView}>
            <Text style={styles.subHeading}>No of Payment</Text>
            <Text style={styles.subHeading1}>56</Text>
          </View>
          <TouchableOpacity
            style={styles.nextButtonContainer3}
            onPress={() => quickLoan()}
          >
            <Text style={styles.nextButton}>Select 18 Months</Text>
          </TouchableOpacity>
        </Card>
      </ScrollView>
    </View>
