    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.subHeading1}>
          Credit4work offers the following loan options to assist your financial
          needs
        </Text>
        <View
          style={{
        ...
        >
          ...
          <View style={{ marginVertical: 10 }}>
            <Text style={{ marginBottom: 10, fontSize: 18 }}>
              Loan Upto <Text style={{ fontWeight: 'bold' }}>$500.00</Text>
            </Text>
            <View style={{ flexDirection: 'row' }}>
              <AntDesign name="checkcircle" size={24} color="green" />
              <Text style={{ marginLeft: 10 }}>Loan with 5-Month Term</Text>
            </View>
            <View style={{ flexDirection: 'row', marginVertical: 10 }}>
              <AntDesign name="checkcircle" size={24} color="green" />
              <Text style={{ marginLeft: 10 }}>0% Interest Rate</Text>
            </View>
            <View style={{ flexDirection: 'row' }}>
              <AntDesign name="checkcircle" size={24} color="green" />
              <Text style={{ marginLeft: 10 }}>$25 Up-front Fee</Text>
            </View>
          </View>
          <TouchableOpacity
            ...
            onPress={() => quickLoan()}
          >
            <Text style={styles.nextButton}>Selct Quick Relief</Text>
          </TouchableOpacity>
        </View>
        <View
          style={{
        ...
        >
          ...
          <View style={{ marginVertical: 10 }}>
            <Text style={{ marginBottom: 10, fontSize: 18 }}>
              Loan Upto <Text style={{ fontWeight: 'bold' }}>$6000.00</Text>
            </Text>
            <View style={{ flexDirection: 'row' }}>
              <AntDesign name="checkcircle" size={24} color="green" />
              <Text style={{ marginLeft: 10 }}>Loan with 5-Month Term</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => flexiLoan()}
          >
            <Text style={styles.nextButton}>Select Flexiable Lifeline</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
