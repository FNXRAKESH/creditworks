    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <TouchableOpacity
          ...
          onPress={() => setPayCycleModalVisible(!payCycleModalVisible)}
        >
          <View style={styles.iconContainer}>
            <Text style={styles.textcenter}>{type}</Text>
            <AntDesign
              name="down"
              size={14}
              color={
                type == 'Select Type' ? 'rgba(34, 42, 53, 0.6)' : '#004ADA'
              }
              style={{ padding: 3 }}
            />
          </View>
        ...
        {!isValidPayCycle ? (
          <HelperText type="error">Paycycle is invalid!</HelperText>
        ) : null}
        <TextInput
        ...
        />
        {!isValidSalary ? (
          <HelperText type="error">Salary is invalid!</HelperText>
        ) : null}

        <TextInput
          style={styles.inputStyle}
          placeholder="Grace Pay Per Period"
          placeholderTextColor="rgba(34, 42, 53, 0.6)"
          keyboardType="numeric"
          value={payPeriod}
          onChangeText={(e) => {
        ...
        />
        {!isValidGracePayPeriod ? (
          <HelperText type="error">Grace Pay Period is invalid!</HelperText>
        ) : null}
        <TextInput
          style={styles.inputStyle}
        ...
        />
        {!isValidDOH ? (
          <HelperText type="error">Date of Hire is invalid!</HelperText>
        ) : null}
        <TouchableOpacity
          style={styles.buttonContainer1}
          onPress={() => setETypeModalVisible(!eTypeModalVisible)}
        >
          <View style={styles.iconContainer}>
            <Text style={styles.textcenter}>{etype}</Text>
            <AntDesign
              name="down"
              size={14}
              color={
                etype == 'Select Type' ? 'rgba(34, 42, 53, 0.6)' : '#004ADA'
              }
              style={{ padding: 3 }}
            />
          </View>
        ...
        <TouchableOpacity
          style={styles.buttonContainer1}
          onPress={() => setJTypeModalVisible(!jTypeModalVisible)}
        >
          <View style={styles.iconContainer}>
            <Text style={styles.textcenter}>{jtype}</Text>
            <AntDesign
              name="down"
              size={14}
              color={
                jtype == 'Select Type' ? 'rgba(34, 42, 53, 0.6)' : '#004ADA'
              }
              style={{ padding: 3 }}
            />
          </View>
        ...
        {!isValidJobTitle ? (
          <HelperText type="error">Job title is invalid!</HelperText>
        ) : null}
        <View style={styles.checkboxContainer}>
          ...
          <Text style={styles.checkboxtext}>
            Authorization for Employer to Share Information with CreditWorks LLC
            <Text style={{ fontSize: 12, color: 'rgba(34, 42, 53, 0.6)' }}>
              {' '}
              I authorize my employer to share my employment information with
              CREDITWORKS LLC, as requested by CREDITWORKS
            </Text>
            <Text
              style={{ color: 'blue' }}
        ...
        {!isValidEmploymentTerms ? (
          <HelperText type="error">Terms of Employement is invalid!</HelperText>
        ) : null}
      </ScrollView>
