    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.subHeading1}>
          Please select your monthy budget{' '}
        </Text>
        ...
        <View style={{ marginBottom: 10 }}>
          ...
          <View style={styles.cellFormat}>
            <Text>Total Monthly NetIncome</Text>
            <Text>$0.00</Text>
          </View>
        </View>
        ...
        />
        <View style={styles.cellFormat}>
          <Text>Total Monthly Expense</Text>
          <Text>$0.00</Text>
        </View>
        <Card style={styles.cardFormat}>
          <View style={styles.cellFormat}>
            <Text>Estimated Future Loan</Text>
            <Text>$0.00</Text>
          </View>
          <View style={styles.cellFormat}>
            <Text>Remaining Available Cash</Text>
            <Text>$0.00</Text>
          </View>
        </Card>
      </ScrollView>
