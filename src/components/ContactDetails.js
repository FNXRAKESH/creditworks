...
const ContactDetails = (props) => {
  ...
  const [isValidResidenceAddress2, setIsValidResidenceAddress2] =
    useState(true);
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View>
          <TouchableOpacity
            ...
            onPress={() => setPNoModalVisible(!pNoModalVisible)}
          >
            <View style={styles.iconContainer}>
              ...
              <AntDesign
                ...
                size={14}
                color={
                  ptype == 'Select Type' ? 'rgba(34, 42, 53, 0.6)' : '#004ADA'
                }
                style={{ padding: 3 }}
              />
            </View>
          ...
          <TouchableOpacity
            style={styles.buttonContainer1}
            onPress={() => setSNoModalVisible(!sNoModalVisible)}
          >
            <View style={styles.iconContainer}>
              <Text
                style={
              ...
              <AntDesign
                ...
                size={14}
                color={
                  stype == 'Select Type' ? 'rgba(34, 42, 53, 0.6)' : '#004ADA'
                }
                style={{ padding: 3 }}
              />
            </View>
          ...
          >
            <View style={styles.iconContainer}>
              ...
              <AntDesign
                ...
                size={14}
                color={
                  rtype == 'Select Type' ? 'rgba(34, 42, 53, 0.6)' : '#004ADA'
                }
                style={{ padding: 3 }}
              />
            </View>
          ...
          <View>
            {showblock3 ? (
              <View style={{ marginTop: 10, marginBottom: 10 }}>
                <TouchableOpacity
                  style={styles.buttonContainer1}
                  onPress={() => setYearsModalVisible(!yearsModalVisible)}
                >
                  <View style={styles.iconContainer}>
                    <Text
                      style={
        ...
        <View style={{ marginLeft: 30 }}>
          ...
          />
          {!isValidHAddress2 ? (
            <HelperText type="error">Address line 2 is invalid!</HelperText>
          ) : null}
          <TextInput
            style={styles.inputStyle}
          ...
          />
          {!isValidHomeZipcode ? (
            <HelperText type="error">Zipcode is invalid!</HelperText>
          ) : null}
          <TextInput
            style={styles.inputStyle}
            placeholder="City"
          ...
          />
          {!isValidHomeCity ? (
            <HelperText type="error">City is invalid!</HelperText>
          ) : null}
          <TextInput
            style={styles.inputStyle}
            placeholder="State"
          ...
          <TextInput
            ...
            placeholder="Address Line 2"
            placeholderTextColor="rgba(34, 42, 53, 0.6)"
            value={residenceAddress2}
            onChangeText={(e) => {
              setResidenceAddress2(e);
              setIsValidResidenceAddress2(true);
            }}
          />
          {!isValidResidenceAddress2 ? (
            <HelperText type="error">
          ...
          />
          {!isValidRZipcode ? (
            <HelperText type="error">Residence Zipcode is invalid!</HelperText>
          ) : null}
          <TextInput
            style={styles.inputStyle}
            placeholder="City"
          ...
          />
          {!isValidRCity ? (
            <HelperText type="error">Residence City is invalid!</HelperText>
          ) : null}
          <TextInput
            style={styles.inputStyle}
            placeholder="State"
          ...
          />
          {!isValidRState ? (
            <HelperText type="error">Residence state is invalid!</HelperText>
          ) : null}
        </View>
        ...
        <View style={styles.checkboxContainer}>
          ...
          <Text style={styles.checkboxtext}>
            You agree that, in order for CREDITWORKS LLC to service this loan or
            to collect any amounts you owe, that we may from time to{' '}
            <Text
              style={{ color: 'blue' }}
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.backButton}>
          <Text style={styles.backButtonText} onPress={() => previousForm()}>
            Back
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
